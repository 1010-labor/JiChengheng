...
int main(int argc, char* argv[]) {
	...
	inputfile = "d:\\test\\data.dat";
	nClus = 4;
	tau = 1.5*0.01;
	metric = 0;
	mode = 1;
	outputfile= "d:\\test\\result.dat";
...
void clustering(const vector<vector<double> >& vec, int nClus, int mode, \
	...
	finish = clock();
	cout << "dm:\t" << (double)(finish - start) / CLOCKS_PER_SEC << endl;
	start = clock();
	...
	finish = clock();
	cout << "dc:\t" << (double)(finish - start) / CLOCKS_PER_SEC << endl;
	start = clock();
	...
	finish = clock();
	cout << "density and sort and deta:\t" << (double)(finish - start) / CLOCKS_PER_SEC << endl;
	start = clock();
	...
	finish = clock();
	cout << "clustering:\t" << (double)(finish - start) / CLOCKS_PER_SEC << endl;
	start = clock();
	...
	finish = clock();
	cout << "density and sort and deta:\t" << (double)(finish - start_0) / CLOCKS_PER_SEC << endl;
